...
export const ImageCropperDropZone: FunctionComponent<DropzonePropModel> = (props: DropzonePropModel) => {
          ...
          <>
            {
              ...
              <div className="flex items-center gap-2 mt-4">
                <Button design="button-gray-100 w-full" text="Vazgeç" onClick={() => { setCroppedImage(props.oldPreview ?? ""); setShowModal(false); }} />
