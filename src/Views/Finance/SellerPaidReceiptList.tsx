...
export const SellerPaidReceiptList: FunctionComponent = () => {
  const sortOptions = [
  ...
  const getSellerPaidReceiptList = async (order: number, searchText: string, page: number, take: number) => {

    const _result = await ApiService.getSellerPaidReceiptList(page, take, searchText, order);
    ...
    <div className="content-wrapper">
      <div className="portlet-wrapper">
        ...
        <Table
          ...
          getDataFunction={getSellerPaidReceiptList}
            ...
            return <div key={"list" + i} className="lg:grid-cols-10 px-2 border-b lg:h-20 border-gray-200 grid gap-4 items-center py-3 lg:py-0">
              ...
              <div className="lg:col-span-2 flex lg:block items-center">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to={{ pathname: `${"/satici-ekstre-detay/" + e.ReceiptId}`, state: { status: 2 } }} >
