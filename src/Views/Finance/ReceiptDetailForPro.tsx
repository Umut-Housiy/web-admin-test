  ...
  return (
    <div className="content-wrapper">
      <div className="portlet-wrapper">
        ...
        <div className="flex">
          <div className="w-1/2 mt-4">
            ...
            <Label loading={loading} descClassName="text-blue-400 text-sm underline font-medium" titleWidth="w-1/5" descWidth="w-4/5" title="Profesyonel Adı" desc={
          ...
          {status === 2 &&
            <div className="w-1/2 mt-4">
              ...
              <Label loading={loading} titleWidth="w-1/5" descWidth="w-4/5" title="Satıcı Hesabı" desc={proAccountInfo} />
      ...
      <Modal
        ...
        body={
          <div>
            <Label className="mt-4" isRequired title="Aktarım Yapılacak Hesap Seçimi (Profesyonel Hesabı)" withoutDots />
