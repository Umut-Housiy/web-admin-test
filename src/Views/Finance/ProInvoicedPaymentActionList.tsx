...
import { InvoicedProPaymentsInnerModel } from "../../Models";
import ApiService from "../../Services/ApiService";
import { returnPaymentType } from "../../Services/Functions";

export const ProInvoicedPaymentActionList: FunctionComponent = () => {
  ...
  const getInvoicedProPaymentActionsForAdmin = async (order: number, searchText: string, page: number, take: number) => {

    const _result = await ApiService.getInvoicedProPaymentActionsForAdmin(page, take, searchText, order);
  ...
  const getDescription = (e: InvoicedProPaymentsInnerModel) => {
  ...
  return (
    <div className="content-wrapper">
      <div className="portlet-wrapper">
        <h2 className="mb-5">
          Faturalandırılmış Profesyonel İşlemleri
        </h2>
        <Table
          ref={tableEl}
          emptyListText={"İşlem Bulunamadı"}
          getDataFunction={getInvoicedProPaymentActionsForAdmin}
          ...
          renderItem={(e, i) => {
            return <div key={"list" + i} className="lg:grid-cols-7 px-2 border-b lg:h-20 border-gray-200 grid gap-4 items-center py-3 lg:py-0">
              ...
              <div className="lg:col-span-1 flex lg:block items-center">
                <span className="p-sm-gray-700 lg:hidden mr-2">Profeyonel Bilgisi:</span>
              ...
              <div className="lg:col-span-1 flex lg:block items-center">
                ...
                <a className="flex items-center text-sm font-medium text-blue-400" href={e.InvoicePath} download={e.InvoiceNo}>
