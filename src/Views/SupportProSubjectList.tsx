...
export const SupportProSubjectList: FunctionComponent = () => {
  ...
  const getSupportSubjectList = async (order: number, searchText: string, page: number, take: number) => {
    ...
    const _result = await ApiService.getSupportSubjectList(page, take, searchText, order, 2);
  ...
  const createSupportSubject = async () => {
    ...
    const _result = await ApiService.createSupportSubject(2, subjectTitle, orderBy);
  ...
  return (
    <div className="content-wrapper">
      <div className="portlet-wrapper">
        <h2 className="mb-5">Profesyonel Destek Konuları</h2>
        <Table
          ref={tableEl}
