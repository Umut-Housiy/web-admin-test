...
export const SupportWebSubjectList: FunctionComponent = () => {
  ...
  const getSupportSubjectList = async (order: number, searchText: string, page: number, take: number) => {
    ...
    const _result = await ApiService.getSupportSubjectList(page, take, searchText, order, 1);
  ...
  const createSupportSubject = async () => {
    ...
    const _result = await ApiService.createSupportSubject(1, subjectTitle, orderBy);
  ...
  return (
    <div className="content-wrapper">
      <div className="portlet-wrapper">
        <h2 className="mb-5">Web Destek Konuları</h2>
        <Table
          ref={tableEl}
