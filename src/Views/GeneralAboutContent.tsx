...
export const GeneralAboutContent: FunctionComponent = () => {
  ...
  const getAboutContentList = async (order: number, searchText: string, page: number, take: number) => {
    ...
    const _result = await ApiService.getAboutContentList(page, take, searchText, order, 4);
    ...
    <div className="content-wrapper">
      <div className="portlet-wrapper">
        ...
        <Table
          ...
          addNewButton={
            <Button buttonMd textTiny color="text-blue-400" className="w-72" design="button-blue-100" text="Yeni İçerik Oluştur" hasIcon icon={<PlusIcon className="icon-sm mr-2" />} onClick={() => { history.push("/genel-hakkimizda-icerik-duzenle"); }} />}
            ...
            return <div key={"list" + i} className="lg:grid-cols-12 px-2 border-b min-h-20 py-5 border-gray-200 hidden lg:grid flex gap-4 items-center">
              ...
              <div className="lg:col-span-4 flex justify-between">
                ...
                <div className="text-gray-700 flex gap-2 items-center">
                  <EditIcon className="icon-sm hover:text-blue-400 cursor-pointer transition-all" onClick={() => { history.push(`/genel-hakkimizda-icerik-duzenle/${e.Id}`); }} />
