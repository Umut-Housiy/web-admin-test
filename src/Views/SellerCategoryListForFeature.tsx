...
export const SellerCategoryListForFeature: FunctionComponent = () => {
  ...
  const getSellerCategoryListForFeature = async (order: number, searchText: string, page: number, take: number) => {

    const _result = await ApiService.getSellerCategoryListForFeature(Number(params.id), page, take, searchText, order);
  ...
  return (
    <div className="content-wrapper">
      <div className="portlet-wrapper">
        ...
        <h2 className="mb-5">Özelliğin Kullanıldığı Kategori Listesi</h2>
        <Table
          ref={tableEl}
          emptyListText={"Veri Bulunamadı"}
          getDataFunction={getSellerCategoryListForFeature}
