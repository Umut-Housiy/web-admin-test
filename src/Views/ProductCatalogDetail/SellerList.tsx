...
export interface SellerListPropModel {
  productId: number
}

export const SellerList: FunctionComponent<SellerListPropModel> = (props: SellerListPropModel) => {
  ...
  const getProductsOtherSellersForAdmin = async (order: number, searchText: string, page: number, take: number) => {

    const _result = await ApiService.getProductsOtherSellersForAdmin(props.productId, page, take, searchText, order);
  ...
  return (
    <>
      <Table
        ...
        getDataFunction={getProductsOtherSellersForAdmin}
        header={
