...
export const GeneralAboutContentEdit: FunctionComponent = () => {
  ...
  const getAboutContentDetail = async () => {
    ...
    if (_result.succeeded === true) {
      ...
      context.showModal({
        ...
        onClose: () => { context.hideModal(); history.push("/genel-hakkimizda-icerikleri"); }
      });
    }
  }
  ...
  const createAboutContent = async () => {
    ...
    const _result = await ApiService.createAboutContent(4, iconUrl, photoUrl, order, title, subTitle, buttonTitle, description);
  ...
  const updateAboutContent = async () => {
    ...
    const _result = await ApiService.updateAboutContent(contentId, 4, iconUrl, photoUrl, order, title, subTitle, buttonTitle, description);
    ...
    <div className="content-wrapper">
      <div className="portlet-wrapper">
        ...
        <div className="flex mt-6">
          <Button isLoading={processLoading} textTiny className="w-24 ml-auto" text="Vazgeç" color="text-gray-400" onClick={() => { history.push("/genel-hakkimizda-icerikleri"); }} />
          {
            contentId > 0 ?
