...
export interface ProductDetailPropModel {
  loading: boolean,
  advertDetail?: ProductAdminDetailModel,
            ...
            }
            {
              props.loading ?
                ...
                <div className="flex mb-2">
                  ...
                  <div className={`${props.advertDetail?.IsEnabled ? "text-green-400" : "text-red-400"} text-sm font-medium ml-2`}>{props.advertDetail?.IsEnabled ? "Aktif" : "Pasif"}</div>
                </div>
            }
          </div>
          <div className="lg:w-1/2">
