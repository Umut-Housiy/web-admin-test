...
import { ProductAdminDetailModel } from "../../Models";
          ...
          <div className="w-1/2 ">
            {
              props.loading ?
                ...
                <div className="flex mb-2">
                  ...
                  <div className="text-sm text-blue-400 underline font-medium ml-2 cursor-pointer" onClick={() => { history.push("/satici-detay/" + props.advertDetail?.AdvertDetail?.SellerId); }}>{props.advertDetail?.AdvertDetail?.StoreName}</div>
                </div>
            }
            {
              props.loading ?
            ...
            }
            {
              props.loading ?
                ...
                <div className="flex mb-2">
                  ...
                  <div className="text-sm text-gray-900 ml-2">{props.advertDetail?.AdvertDetail?.StockCode}</div>
                </div>
            }
            {
              props.loading ?
                ...
                <div className="flex mb-2">
                  ...
                  <div className="text-sm text-gray-900 ml-2">{props.advertDetail?.AdvertDetail?.Stock ?? 0}</div>
                </div>
            }
            {
              props.loading ?
            ...
            }
            {
              props.loading ?
                ...
                <div className="flex mb-2">
                  ...
                  <div className="text-sm text-gray-900 ml-2">{(props.advertDetail?.AdvertDetail?.ShippingPrepareDay ?? 0) + " gün"}</div>
                </div>
            }
            {
              props.loading ?
                ...
                <div className="flex mb-2">
                  ...
                  <div className={`${props.showProduct ? "text-blue-400" : "text-red-400"} font-medium text-sm  ml-2`}>{props.showProduct ? "Aktif" : "Pasif"}</div>
                </div>
            }
          </div>
          <div className=" w-1/2">
            {
              props.loading ?
                ...
                <div className="flex mb-2">
                  ...
                  <div className="text-sm text-gray-900 ml-2">{fraction.format(props.advertDetail?.AdvertDetail?.MarketPrice ?? 0) + " TL"}</div>
                </div>
            }
            {
              props.loading ?
                ...
                <div className="flex mb-2">
                  ...
                  <div className="text-sm text-gray-900 ml-2">{fraction.format(props.advertDetail?.AdvertDetail?.SalePrice ?? 0) + " TL"}</div>
                </div>
            }
            {
              props.loading ?
