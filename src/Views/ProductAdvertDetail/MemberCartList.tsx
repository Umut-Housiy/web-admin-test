...
export const MemberCartList: FunctionComponent<MemberCartListPropModel> = (props: MemberCartListPropModel) => {
  ...
  const getShoppingCartUsersForAdvert = async (order: number, searchText: string, page: number, take: number) => {

    const _result = await ApiService.getShoppingCartUsersForAdvert(props.advertId, page, take, searchText, order);
  ...
  return (
    <>
      <Table
        ...
        getDataFunction={getShoppingCartUsersForAdvert}
