...
export const ProductAdvertDraftList: FunctionComponent = () => {
  ...
  const getProductDraftList = async (order: number, searchText: string, page: number, take: number) => {

    const _result = await ApiService.getProductDraftList(page, take, searchText, order);
  ...
  return (
    <div className="content-wrapper">
      <div className="portlet-wrapper">
        <h2 className="mb-5">Onay Bekleyen İlanlar</h2>
        <Table
          ref={tableEl}
          key={"1"}
          emptyListText={"İlan Bulunamadı"}
          getDataFunction={getProductDraftList}
            ...
            return <div key={"list" + i} className="lg:grid-cols-12 px-2 border-b h-20 border-gray-200 hidden lg:grid flex gap-4 items-center">
              ...
              <div className="lg:col-span-1 flex justify-between">
                ...
                <div className="text-gray-700 flex gap-2 items-center">
                  <Link to={{ pathname: `/onay-bekleyen-ilan-detay/${e.DraftId}`, state: { prevPath: window.location.pathname, queryPage: Number(readPageQueryString(window.location) ?? "1") } }} >
